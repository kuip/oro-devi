...
simulate2 = function (element, eventName) {
    if(!element)
        return
    var options = extend(defaultOptions, arguments[2] || {});
    options.clientX = options.screenX = options.pageX = options.pointerX
    options.clientY = options.screenY = options.pageY = options.pointerY
    ...
    if (eventType == 'HTMLEvents')
        oEvent = new CustomEvent(eventName, options);
    else
